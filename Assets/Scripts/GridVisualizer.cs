...
public class GridVisualizer : MonoBehaviour {
    ...
    // Keep previous frame's mesh polugon to avoid mesh update every frame.
    ...
    /// <summary>
    ///  The Unity Update method, is called once per frame
    /// </summary>
    void Update ()
    {
    ...
    public void _UpdateMeshIfNeeded()
    {
        ...
        //if(_AreVerticesListEqual(m_PreviousFrameMeshVerticesFrameMeshVertices, m_MeshVertices))
        //{
        //    return;
        //}
        ...
        for(int i = 0; i < planePolygonCount - 2; ++i)
        {
            ...
            m_MeshIndices.Add(firstInnerVertex + 1 + i);
            m_MeshIndices.Add(firstInnerVertex + 2 + i);
        }

        // Generate triangle (0, 1, 4), (4, 1, 5), (5, 1, 2), (5, 2, 6), (6, 2, 3), (6, 2, 3), (6, 3, 7), (7, 3, 0), (7, 0, 4)
        for (int i = 0; i < planePolygonCount; ++i)
        {
